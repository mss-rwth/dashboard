...
#pop.title-box(
  title: "bryne - prototyping reusable solvers for coupled multiphysics PDE models",
...
#grid(
    ...
    #columns(3,[
      #pop.column-box(heading: "Schematic Flow Chart")[
        #figure[#image("SHIRE-Flowchart.jpg", width: 100%)]]

        #pop.column-box(heading: "Acknowlegments")[
        #figure[#image("acknowldegments.png", width: 100%)]
  ]
...
//      #pop.column-box(heading: "Summary" )[
        ...
        #figure[#link("https://git.rwth-aachen.de/mbd/shire#user-content-how-to-use-shire")[#image("bryne_img.png", width: 100%)]]
        #cite(<terschanski_2025_15789249>)
    ...
    #figure[
          #image("python.png", width: 20%)
          ]
        Python-based modular framework can be complemented with individual modules.  
  ]

      #pop.column-box()[
        #text(size: 40pt)[#bibliography("bibliography-bryne.bib")]
      ]
    ...
    box(width: 100%)[#pop.set-theme(pop.uni-fr-middle-pink)
        #pop.column-box(heading: "      Overview",stretch-to-next: true)[
          ...
          #place(bottom+center,figure[#image("gitlab-qr-box.png", width: 80%)])
          ]
    ],
