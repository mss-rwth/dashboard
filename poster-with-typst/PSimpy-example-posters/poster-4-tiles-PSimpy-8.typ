...
#titled-box-top(
  ...
  bg-color: box-bg-color,
  body: [
    #align(center)[#text(font: title-font,size: 50pt, weight: "bold", fill:text-color)[Quantify uncertainty. Identify key drivers. Calibrate with data.]]
...
#no-title-box(
  ...
  body:[
    ...
    #align(right)[
      #link("https://www.mss.rwth-aachen.de/cms/~eiqx/mss/?lidx=1")[
        #image("./Misc/mss-rwth.png", height: 150%)
      ]
]
  ...
  height-body: 7%,
    ...
    #floating-box(
      ...
      #text(font: font-catch-phrase,size: 40pt , weight: "bold")[#cite(<zhao_et_al_2023>)]
        ...
        #move(dy:-300pt)[#image("./Content_pysimpy/qr-pysimpy.png",width: 400pt)]
  /*
