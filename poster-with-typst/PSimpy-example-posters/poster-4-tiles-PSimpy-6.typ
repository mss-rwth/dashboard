...
#let box-bg-color = rgb(232,241,250).desaturate(50%)
// color of the frames of the three content boxes
#let box-frame-color = rgb(142, 186, 229)
// background color of the title box
#let title-box-bg-color = rgb(142, 186, 229)
#let title-box-text-color = black
...
#logo-box(
  ...
  #titled-box-top(
    ...
    body: [
      ...
      #align(left)[#text(font: title-font,size: 50pt, weight: "regular", fill:black)[Create lightweight Surrogate model]]
    #align(left)[#text(font: title-font,size: 50pt, weight: "bold", fill:black)[and save precious compute time!]]

    #align(left)[#text(font: title-font,size: 40pt, weight: "regular", fill:black)[Case study ...]]
      ...
      #align(left)[#text(font: text-font,size: text-size, weight: "regular", fill: black)[
...
#set par(justify: true)
    #align(center)[#text(font: title-font,size: 50pt, weight: "bold", fill:black)[Quantify uncertainty. Identify key drivers.]]
    #align(center)[#text(font: title-font,size: 50pt, weight: "bold", fill:black)[Calibrate with data.]]

#align(left)[#text(font: text-font,size: 50pt, weight: "bold", fill: black)[
        #set list(marker: [ ], spacing: 1em) //‣
          - Bayesian Calibration
          - Global Sensitivity Analysis #text(font: text-font,size: 40pt, weight: "regular", fill: black)[(Sobol indices)]
          - Efficient Sampling #text(font: text-font,size: 40pt, weight: "regular", fill: black)[(Saltelli, LHS, Metropolis Hastings)]
          - Active Learning
...
#no-title-box(
  ...
  body:[
    ...
    #text(size: text-size, fill:text-color, font: text-font)[#bibliography(title:none,"./Content_pysimpy/bibliography-pysimpy.bib")]
...
#no-title-box(
  ...
  bg-color: rgb(250,190, 80).desaturate(20%),//rgb(142, 186, 229),// rgb(250, 190, 80).desaturate(20%),
  //#move(dx:2000pt)
...
//#figure[#link("https://git.rwth-aachen.de/mbd/shire#user-content-how-to-use-shire")[#image("./Content_pysimpy/pysimpy-Logo_small.png", width: 100%)]]
      ...
      color-frame: gradient.linear(rgb(142, 186, 229),rgb(241, 158, 176),rgb(250,190, 80),angle: 90deg),// rgb(250, 190, 80),
