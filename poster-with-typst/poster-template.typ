...
#let title-box-text-size-big= 80pt
#let title-box-text-size-small= 50pt
...
#title-box(
  ...
  title-text-size-big: title-box-text-size-big,
  title-text-size-small: title-box-text-size-small,
...
// >>>>  insert citation key of your publication here, e.g. cite(<zhao_et_al_2023>) <<<
  ...
  software-logo: "./Content_pysimpy/pysimpy-logo-vectorized.svg",
  // link to the software repository
  software-logo-link: "https://mbd.pages.rwth-aachen.de/psimpy/",
  // QR code for the software repository
  qr-code: "./Content_pysimpy/qr-code-pysimpy.png"
)